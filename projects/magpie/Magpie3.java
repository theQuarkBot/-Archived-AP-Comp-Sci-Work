...
public class Magpie3
{
		...
		if (statement.length() > 0)
		{
					...
					|| statement.indexOf("brother") >= 0)
			{
				response = "Tell me more about your family.";
					...
					|| statement.indexOf("animals") >= 0)
			{
				response = "Tell me more about your animals.";
			}
			else if (statement.indexOf("pizza") >= 0)
			{
				response = "I like pizza, just not if it has meat on it.";
			}
	...
	private String getRandomResponse()
	{
		...
		{
			response = "Quite so... Quite so...";
		}
		else if (whichResponse == 5)
		{
			response = "I wonder... No, nevermind.";
		}
